"""
Elementary CA — Wolfram Rule 110  (Interactive GUI)
...
RULE 110
--------
Rule 110 is Class IV (complex / Turing-complete).  It is one of the simplest
known universal computers: given suitable initial conditions, it can simulate
any computation.  Patterns contain gliders that interact in structured ways.

To run:
    python experiments/wolfram/wolfram_rule110.py
"""
...
GRID_SIZE = 201       # number of cells; try 101 or 401 for narrower/wider patterns
...
# initial_states → 'single_center' is the canonical starting point for Rule 110;
#                  'random' can trigger a wider variety of glider collisions
grid = Grid1D(
    size=GRID_SIZE,
    radius=1,
    boundary='periodic',
